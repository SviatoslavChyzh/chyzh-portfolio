...
import { defaultParseSearch, isRedirect as isRedirect$1, isNotFound, createRootRoute, Outlet, ScrollRestoration, createFileRoute, lazyRouteComponent, useRouter, useRouterState, Link, RouterProvider, createMemoryHistory, ScriptOnce, createRouter as createRouter$2, pick, isPlainArray, isPlainObject as isPlainObject$1, useMatch, rootRouteId, ErrorComponent, defer as defer$1, createControlledPromise } from '@tanstack/react-router';
import E from 'tiny-invariant';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import * as g from 'react';
import { createContext as createContext$1, createElement, useState, useEffect, useContext } from 'react';
import _ from 'jsesc';
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/.data/kv"}));
...
const appConfig = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio","order":0,"outDir":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio","outDir":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio","base":"/","outDir":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio","outDir":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio"};
				const buildManifest = {"client":{"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/app/globals.css":{"file":"assets/globals-DZyZsH2T.css","src":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/app/globals.css"},"_client-BxjpI9UA.js":{"file":"assets/client-BxjpI9UA.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split"],"assets":["assets/globals-DZyZsH2T.css"]},"app/assets/avatar.jpg":{"file":"assets/avatar-BJAW_CWN.jpg","src":"app/assets/avatar.jpg"},"app/routes/index.tsx?tsr-split":{"file":"assets/index-D5Bfr0aS.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-BxjpI9UA.js"],"assets":["assets/avatar-BJAW_CWN.jpg"]},"virtual:$vinxi/handler/client":{"file":"assets/client-pZQxO3iq.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-BxjpI9UA.js"]}},"ssr":{"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/app/globals.css":{"file":"assets/globals-DZyZsH2T.css","src":"/Users/Sviatoslav.Chyzh/Documents/Slavik/projects/chyzh-portfolio/app/globals.css"},"_ssr-ZlN8JW30.js":{"file":"assets/ssr-ZlN8JW30.js","name":"ssr","dynamicImports":["app/routes/index.tsx?tsr-split"],"assets":["assets/globals-DZyZsH2T.css"]},"app/assets/avatar.jpg":{"file":"assets/avatar-BJAW_CWN.jpg","src":"app/assets/avatar.jpg"},"app/routes/index.tsx?tsr-split":{"file":"assets/index-BabbpXxs.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-ZlN8JW30.js"],"assets":["assets/avatar-BJAW_CWN.jpg"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-ZlN8JW30.js"]}},"server":{"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function P(e){let n;const t=T$1(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(t,{...s,body:e.node.req.body}):new Request(t,{...s,get body(){return n||(n=q$1(e),n)}})}function j$1(e){return e.web??={request:P(e),url:T$1(e)},e.web.request}function I(){return b()}const S=Symbol("$HTTPEvent");function U(e){return typeof e=="object"&&(e instanceof H3Event||e?.[S]instanceof H3Event||e?.__is_event__===!0)}function y(e){return function(...n){let t=n[0];if(U(t))n[0]=t instanceof H3Event||t.__is_event__?t:t[S];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(t=I(),!t)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");n.unshift(t);}return e(...n)}}const T$1=y(getRequestURL),W=y(getResponseStatus),q$1=y(getRequestWebStream);function J(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function b(){return J().use().event}function $$1(e){return globalThis.MANIFEST[e]}const p="server-fn-return-type",l="server-fn-payload-type",V=eventHandler(M$1);async function M$1(e){return k$1(j$1(e))}async function k$1(e,n){var t,s;const a=e.method,h=new URL(e.url,"http://localhost:3000"),i=Object.fromEntries(new URLSearchParams(h.search).entries()),c=i._serverFnId,v=i._serverFnName;if(!c||!v)throw new Error("Invalid request");E(typeof c=="string","Invalid server action");const _=(s=await((t=$$1("server").chunks[c])==null?void 0:t.import()))==null?void 0:s[v],u=await(async()=>{try{const r=await(async()=>{var g;return e.headers.get(l)==="payload"?[a.toLowerCase()==="get"?(()=>{var f;return (f=defaultParseSearch(h.search))==null?void 0:f.payload})():await e.json(),{method:a,request:e}]:e.headers.get(l)==="formData"||(g=e.headers.get("Content-Type"))!=null&&g.includes("multipart/form-data")?[a.toLowerCase()==="get"?(()=>{const{_serverFnId:f,_serverFnName:D,payload:x}=i;return x})():await e.formData(),{method:a,request:e}]:e.headers.get(l)==="request"?[e,{method:a,request:e}]:await e.json()})(),o=await _(...r);return o instanceof Response?o:isRedirect$1(o)||isNotFound(o)?R(o):new Response(o!==void 0?JSON.stringify(o):void 0,{status:W(b()),headers:{"Content-Type":"application/json",[p]:"json"}})}catch(r){return r instanceof Response?r:isRedirect$1(r)||isNotFound(r)?R(r):(console.error("Server Fn Error!"),console.error(r),console.info(),new Response(JSON.stringify(r),{status:500,headers:{"Content-Type":"application/json",[p]:"error"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const o=await u.clone().text();o&&JSON.stringify(JSON.parse(o));}return u}function R(e){const{headers:n,...t}=e;return new Response(JSON.stringify(t),{status:200,headers:{"Content-Type":"application/json",[p]:"json",...e.headers||{}}})}
...
function xe(e, t, r) {
  ...
  return T(t, (s, a) => {
    const c = s instanceof ReadableStream ? "stream" : s instanceof Promise ? "promise" : void 0;
    if (c) {
      const u = { dataType: e, type: c, path: a, id: n.length, value: s, matchIndex: r.match.index };
      if (n.push(u), c === "stream") {
        const [l, d] = s.tee();
        return u.streamState = Re({ stream: d }), l;
      } else
        defer$1(s);
    }
    return s;
...
function Se(e) {
  ...
  if (!t.isServer)
    return null;
  const n = r.extracted, [o, s] = ["__beforeLoadContext", "loaderData"].map((a) => n ? n.reduce((c, u) => u.dataType !== a ? k(c, ["temp", ...u.path], void 0) : c, { temp: r[a] }).temp : r[a]);
  return jsxs(Fragment, { children: [o !== void 0 || s !== void 0 || (n == null ? void 0 : n.length) ? jsx(ScriptOnce, { children: `__TSR__.matches[${e.matchIndex}] = ${_({ __beforeLoadContext: t.options.transformer.stringify(o), loaderData: t.options.transformer.stringify(s), extracted: n ? Object.fromEntries(n.map((a) => [a.id, pick(a, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })}; __TSR__.initMatch(${e.matchIndex})` }) : null, n ? n.map((a, c) => a.type === "stream" ? jsx(we, { entry: a }, a.id) : jsx(_e, { entry: a }, a.id)) : null] });
}
function T(e, t, r = []) {
  if (isPlainArray(e))
    return e.map((o, s) => T(o, t, [...r, `${s}`]));
...
function _e({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(g.Suspense, { fallback: null, children: jsx(ve, { entry: e }) }) });
}
function ve({ entry: e }) {
  if (e.value.status === "pending")
    throw e.value;
  return jsx(ScriptOnce, { children: `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].resolve(${_(e.value.data, { isScriptContext: true, wrap: true, json: true })})` });
}
function we({ entry: e }) {
  return E(e.streamState, "StreamState should be defined"), jsx($, { streamState: e.streamState, children: (t) => jsx(ScriptOnce, { children: t ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${_(t.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()` }) });
}
...
function $({ streamState: e, children: t, __index: r = 0 }) {
  ...
  if (n.status === "pending")
    throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [t(o), jsx("div", { className: "tsr-once", children: jsx(g.Suspense, { fallback: null, children: jsx($, { streamState: e, __index: r + 1, children: t }) }) })] });
}
function k(e, t, r) {
  if (t.length === 0)
    return r;
  const [n, ...o] = t;
  return Array.isArray(e) ? e.map((s, a) => a === Number(n) ? k(s, o, r) : s) : isPlainObject$1(e) ? { ...e, [n]: k(e[n], o, r) } : e;
}
function H(e) {
  e.router.AfterEachMatch = Se, e.router.serializer = (n) => _(n, { isScriptContext: true, wrap: true, json: true });
  const t = Context.get("TanStackRouterHydrationContext", {}), r = g.useMemo(() => {
    var n, o;
...
function Te(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: be(e), url: q(e) }, e.web.request;
}
function ke() {
  return Pe();
}
...
function C(e) {
  return function(...t) {
    ...
    let r = t[0];
    if (Ce(r))
      t[0] = r instanceof H3Event || r.__is_event__ ? r : r[A];
    else {
...
const q = C(getRequestURL), Ee = C(getResponseHeaders), He = C(getRequestWebStream);
function Me() {
  var _a;
...
const Le = "server-fn-return-type", $e = "server-fn-payload-type";
function Ae({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const o = Te(n), s = new URL(o.url), a = s.href.replace(s.origin, ""), c = createMemoryHistory({ initialEntries: [a] }), u = e();
    u.serializeLoaderData = xe, t && (u.manifest = t()), u.update({ history: c }), await u.load();
    const l = qe({ event: n, router: u });
    return await r({ request: o, router: u, responseHeaders: l });
  });
}
function qe(e) {
  e.event.__tsrHeadersSent = true;
  let t = M(Ee(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: r } = e.router.state;
  return r && (t = M(t, r.headers, { Location: r.href })), [Le, $e].forEach((n) => {
    t.delete(n);
  }), t;
}
function Ne(e) {
  const t = N(() => e.injectedHtml.map((r) => r()).join(""));
...
function Be(e) {
  const t = N(() => e.injectedHtml.map((n) => n()).join("")), r = new TextEncoder();
...
const De = /(<body)/, je = /(<\/body>)/, Fe = /(<\/html>)/, Oe = /(<\/[a-zA-Z][\w:.-]*?>)/g, We = new TextDecoder();
function N(e) {
  let t = false, r = "", n = "";
  return { async transform(o, s) {
    const a = r + We.decode(o), c = a.match(De), u = a.match(je), l = a.match(Fe);
    try {
      if (c && (t = true), !t) {
        s(a), r = "";
        return;
      ...
      if (u && l && u.index < l.index) {
        const p = u.index + u[0].length, h = l.index + l[0].length, w = a.slice(0, p) + d + a.slice(p, h) + a.slice(h);
        s(w), r = "";
      } else {
        let p, h = 0;
        for (; (p = Oe.exec(a)) !== null; )
          h = p.index + p[0].length;
        if (h > 0) {
          const w = a.slice(0, h) + d + n;
          s(w), r = a.slice(h);
        } else
          r = a, n += d;
      }
...
const Ue = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof v.renderToReadableStream == "function") {
    const n = await v.renderToReadableStream(jsx(H, { router: t }), { signal: e.signal, onError(a, c) {
      console.error(a, c);
    } });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const s = [Be(t)].reduce((a, c) => a.pipeThrough(c), n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  if (typeof v.renderToPipeableStream == "function") {
    const n = new PassThrough(), o = v.renderToPipeableStream(jsx(H, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      o.pipe(n);
    } } : { onShellReady() {
      o.pipe(n);
    } }, onShellError(c) {
      throw c;
    } }), a = [Ne(t)].reduce((c, u) => c.pipe(u), n);
    return new Response(a, { status: t.state.statusCode, headers: r });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, ze = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-pZQxO3iq.js", "/_build/assets/client-BxjpI9UA.js"] }, "/": { filePath: "index.tsx" } } });
function Ze(e) {
  return globalThis.MANIFEST[e];
}
function Ge() {
  var _a;
  const e = ze(), t = e.routes.__root__ = e.routes.__root__ || {};
  t.assets = t.assets || [];
  const r = Ze("client");
...
const Ve = () => {
  const e = useRouter(), t = useRouterState({ select: (s) => s.matches.map((a) => a.meta).filter(Boolean) }), r = g.useMemo(() => {
    const s = [], a = {};
    let c;
  ...
  }, [t]), n = useRouterState({ select: (s) => s.matches.map((a) => a.links).filter(Boolean).flat(1).map((a) => ({ tag: "link", attrs: { ...a } })) }), o = useRouterState({ select: (s) => {
    const a = [];
    return s.matches.map((c) => e.looseRoutesById[c.routeId]).forEach((c) => {
      ...
      return (d = (l = (u = e.manifest) == null ? void 0 : u.routes[c.id]) == null ? void 0 : l.preloads) == null ? void 0 : d.filter(Boolean).forEach((p) => {
        a.push({ tag: "link", attrs: { rel: "modulepreload", href: p } });
      });
    }), a;
  } });
  return tt([...r, ...o, ...n], (s) => JSON.stringify(s));
}, Qe = () => {
  const e = useRouter(), t = Ve(), r = g.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [jsx("meta", { name: "tsr-meta" }), t.map((n, o) => createElement(B, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: `
__TSR__ = {
  matches: [],
  streamedValues: {},
  initMatch: (index) => {
...
}` }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${_(e.options.transformer.stringify(r), { isScriptContext: true, wrap: true, json: true })}` })] }), jsx("meta", { name: "/tsr-meta" })] });
}, Xe = ({ children: e }) => {
  const t = useRouter(), r = Qe(), [n, o] = g.useState(false);
  g[typeof document < "u" ? "useLayoutEffect" : "useEffect"](() => {
    if (typeof document > "u")
      return;
    const a = document.head.querySelector('meta[name="tsr-meta"]'), c = document.head.querySelector('meta[name="/tsr-meta"]');
    let u = a == null ? void 0 : a.nextElementSibling;
    for (; u && u !== c; ) {
      const l = u.nextElementSibling;
      u.remove(), u = l;
    }
    a == null ? void 0 : a.remove(), c == null ? void 0 : c.remove(), o(true);
  }, []);
  const s = jsxs(Fragment, { children: [r, e] });
  return t.isServer ? s : n ? createPortal(s, document.head) : null;
};
...
const rt = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => {
    ...
    return o.matches.map((a) => e.looseRoutesById[a.routeId]).forEach((a) => {
      var c, u, l;
      return (l = (u = (c = e.manifest) == null ? void 0 : c.routes[a.id]) == null ? void 0 : u.assets) == null ? void 0 : l.filter((d) => d.tag === "script").forEach((d) => {
        s.push({ tag: "script", attrs: d.attrs, children: d.children });
      });
    }), s;
  } }), { scripts: r } = useRouterState({ select: (o) => ({ scripts: o.matches.map((s) => s.scripts).filter(Boolean).flat(1).map(({ children: s, ...a }) => ({ tag: "script", attrs: { ...a, suppressHydrationWarning: true }, children: s })) }) }), n = [...r, ...t];
  return jsx(Fragment, { children: n.map((o, s) => createElement(B, { ...o, key: `tsr-scripts-${o.tag}-${s}` })) });
};
function D({ children: e }) {
  return jsxs("div", { className: "space-y-2 p-2", children: [jsx("div", { className: "text-gray-600 dark:text-gray-400", children: e || jsx("p", { children: "The page you are looking for does not exist." }) }), jsxs("p", { className: "flex flex-wrap items-center gap-2", children: [jsx("button", { onClick: () => window.history.back(), className: "rounded bg-emerald-500 px-2 py-1 text-sm font-black uppercase text-white", children: "Go back" }), jsx(Link, { to: "/", className: "rounded bg-cyan-600 px-2 py-1 text-sm font-black uppercase text-white", children: "Start Over" })] })] });
}
const nt = ({ title: e, description: t, keywords: r, image: n }) => [{ title: e }, { name: "description", content: t }, { name: "keywords", content: r }, { name: "twitter:title", content: e }, { name: "twitter:description", content: t }, { name: "twitter:creator", content: "@tannerlinsley" }, { name: "twitter:site", content: "@tannerlinsley" }, { name: "og:type", content: "website" }, { name: "og:title", content: e }, { name: "og:description", content: t }, ...n ? [{ name: "twitter:image", content: n }, { name: "twitter:card", content: "summary_large_image" }, { name: "og:image", content: n }] : []], ot = "/_build/assets/globals-DZyZsH2T.css", st = { theme: "system", setTheme: () => null }, j = createContext$1(st);
function Ct({ children: e, defaultTheme: t = "system", storageKey: r = "ui-theme", ...n }) {
  const [o, s] = useState(() => localStorage.getItem(r) || t);
  useEffect(() => {
  ...
  const a = { theme: o, setTheme: (c) => {
    localStorage.setItem(r, c), s(c);
  } };
  return jsx(j.Provider, { ...n, value: a, children: e });
}
const Et = () => {
  const e = useContext(j);
  if (e === void 0)
    throw new Error("useTheme must be used within a ThemeProvider");
  return e;
}, F = createRootRoute({ meta: () => [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "Sviatoslav Chyzh - Software Engineer" }, ...nt({ title: "TanStack Start | Type-Safe, Client-First, Full-Stack React Framework", description: "TanStack Start is a type-safe, client-first, full-stack React framework. " })], links: () => [{ rel: "stylesheet", href: ot }], notFoundComponent: () => jsx(D, {}), component: at });
function at() {
  return jsx(it, { children: jsx(Outlet, {}) });
}
function it({ children: e }) {
  return jsxs(Ye, { children: [jsx(Ke, { children: jsx(Xe, {}) }), jsxs(et, { children: [e, jsx(ScrollRestoration, {}), jsx(rt, {})] })] });
}
const ct = () => import('./build/index-BabbpXxs.mjs'), O = createFileRoute("/")({ component: lazyRouteComponent(ct, "component", () => O.ssr) }), ut = O.update({ id: "/", path: "/", getParentRoute: () => F }), lt = { IndexRoute: ut }, dt = F._addFileChildren(lt)._addFileTypes();
function mt({ error: e }) {
...
function ft() {
  return createRouter$2({ routeTree: dt, defaultErrorComponent: mt, defaultNotFoundComponent: () => jsx(D, {}) });
}
const Ht = Ae({ createRouter: ft, getRouterManifest: Je })(Ue);
...
export { Ct as C, Et as E, node$1 as n, vercel as v };
